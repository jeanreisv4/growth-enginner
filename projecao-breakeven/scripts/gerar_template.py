...
Sem argumentos de premissas, o gerador reconstrói a planilha demo (agência de viagens + e-commerce de tecidos): python3 gerador/build_workbook.py saida.xlsx
"""
